...
A collection of self-directed Python and machine learning projects covering classic supervised learning tasks and conversational AI, built while studying core ML concepts and frameworks (scikit-learn, XGBoost, Flask, Rasa).
...
- **Conversational AI**: ChatterBot, Rasa, Flask

## Notes

Each project is a self-contained Jupyter notebook with data loading, preprocessing, model training, and evaluation. These were built as hands-on learning exercises covering foundational supervised learning and conversational AI techniques.

## Contact

**Obule Peter Kasobi**
peter.obule91@gmail.com · [LinkedIn](https://www.linkedin.com/in/peter-obule-878688184)
